;if(CloudflareApps.matchPage(CloudflareApps.installs['VIKQFpsEZkDx'].URLPatterns)){(function(){'use strict'
...
if("VIKQFpsEZkDx"==='preview'||!stored){visible=true}else{var timeframe=times[options.renew]
...
window.CloudflareApps.installs['VIKQFpsEZkDx'].scope={updateOptions:function updateOptions(nextOptions){clearTimeout(visibilityTimeout)
options=nextOptions
updateContent()
